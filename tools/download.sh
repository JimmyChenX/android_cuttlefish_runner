...
wget -nv "https://ci.android.com/builds/submitted/15885347/aosp_cf_x86_64_only_phone-userdebug/latest/raw/aosp_cf_arm64_only_phone-img-15885347.zip" -O ${DEVICE}-img.zip
